                                                ...
                                                <div className="flex items-start justify-end">
                                                    <div className="ml-3 flex h-7 items-center">
                                                        <button 
                                                            onClick={onClose}
                                                            type="button"
                                                            className="rounded-md bg-white text-gray-400 hover:text-gray-600 focus:outline-none focus-ring-2 focus:ring-sky-500 focus:ring-offset-2"
                                                        >
                                                ...
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="w-full pb-5 pt-5 sm:px-0 sm:pt-0">
                                                        <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                            {data.isGroup && (
                                                                <div>
                                                                    <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">그룹 이메일</dt>
                                                            ...
                                                            {!data.isGroup && (
                                                                <div>
                                                                    <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">이메일</dt>
                                                            ...
                                                            {!data.isGroup && (
                                                                <>
                                                                    <hr/>
                                                                    <div>
                                                                        <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">가입</dt>
                                                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">
